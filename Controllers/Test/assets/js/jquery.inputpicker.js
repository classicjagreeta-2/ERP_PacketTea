    ...
    function _loadData(input, data, func) {
        ...
        if (_set(input, 'url')) {
            ...
            _execJSON(input, param, function (ret) {
                ...
                else if (ret && _isArray(ret.data)) {
                    resultData = ret.data;
                }
                else {
                    //_alert(
                    //    "The type of data(" +
                    //    (ret && ret.data ? typeof ret.data : typeof ret) +
                    //    ") is incorrect.",
                    //    input
                    //);

                    resultData = _set(input, 'data');
                }

                // Load data into inputpicker
                if (_isArray(resultData)) {
                    methods.data.call(input, resultData);
                }
                ...
                if (typeof func == 'function') {
                    func.call(this, input, resultData);
                }
            });
