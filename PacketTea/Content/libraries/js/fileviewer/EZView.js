...
$.fn.EZView = function(){
        ...
        //if (!$('#EZView').length) {
            ...
            var tools =
                ...
                container = '<div class="object"/>'+
                        ...
                        tools,
                template = '<div id="EZView" class="hide1 container" style="display: none; align-items: center; justify-content: center">'+container+'</div>';
    ...
    self.setObjectTemplate = function(object){
        ...
        // Append object to body
         $EZView.find('.object').empty().append(object[0])
